...
public class RpropNeuralNode
  ...
  /** for serialization */
  private static final long serialVersionUID = -1085750607680839123L;
  ...
  private double[] m_previous_weights;
  //###############################################################################
  ...
  public RpropNeuralNode(String id, Random r, RpropNeuralMethod m) {
    ...
    m_previous_weights=new double[1];
  ...
  public void updateWeights(RpropNeuralNode node,double positiveEta,double negetiveEta){
