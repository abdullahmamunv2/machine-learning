 ...
 * @version $Revision$
 */
public interface RpropNeuralMethod extends Serializable {
   ...
   * @return The value.
   */
  double outputValue(RpropNeuralNode node);
   ...
   * @return The error.
   */
  double errorValue(RpropNeuralNode node);
  ...
  //############################################################
  void updateWeights(RpropNeuralNode node,double positiveEta,double negetiveEta);
  //#########################################################
