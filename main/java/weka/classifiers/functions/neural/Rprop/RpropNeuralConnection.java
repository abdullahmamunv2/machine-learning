...
package weka.classifiers.functions.neural.Rprop;
 ...
 * @version $Revision$
 */
public abstract class RpropNeuralConnection
  implements Serializable, RevisionHandler {

  /** for serialization */
  private static final long serialVersionUID = -286123828571059163L;
  ...
  protected RpropNeuralConnection[] m_inputList;

  /** The list of outputs from this unit. */
  protected RpropNeuralConnection[] m_outputList;
   ...
   */
  public RpropNeuralConnection(String id) {
    
    m_id = id;
    m_inputList = new RpropNeuralConnection[0];
    m_outputList = new RpropNeuralConnection[0];
  ...
  public void updateWeights(double positiveEta,double negetiveEta){
	...
	m_inputList[noa].updateWeights(positiveEta, negetiveEta);
      }
   ...
   */
  public RpropNeuralConnection[] getInputs() {
    return m_inputList;
  }
   ...
   */
  public RpropNeuralConnection[] getOutputs() {
    return m_outputList;
  }
   ...
   */
  protected boolean connectInput(RpropNeuralConnection i, int n) {
  ...
  protected void allocateInputs() {
    ...
    RpropNeuralConnection[] temp1 = new RpropNeuralConnection[m_inputList.length + 15];
   ...
   * @return True if the connection was made, false otherwise.
   */
  protected boolean connectOutput(RpropNeuralConnection o, int n) {
  ...
  protected void allocateOutputs() {
    ...
    RpropNeuralConnection[] temp1 
      = new RpropNeuralConnection[m_outputList.length + 15];
   ...
   * not found.
   */
  protected boolean disconnectInput(RpropNeuralConnection i, int n) {
   ...
   * not found.
   */  
  protected boolean disconnectOutput(RpropNeuralConnection o, int n) {
   ...
   */
  public static boolean connect(RpropNeuralConnection s, RpropNeuralConnection t) {
   ...
   */
  public static boolean disconnect(RpropNeuralConnection s, RpropNeuralConnection t) {
